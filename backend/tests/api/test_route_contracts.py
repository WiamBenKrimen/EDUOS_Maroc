...
EXPECTED_ROUTES = {
    ...
    ("GET", "/api/director/assistant/status"),
    ("POST", "/api/director/assistant/chat"),
    ("POST", "/api/director/assistant/actions/{action_id}/confirm"),
    ("POST", "/api/director/assistant/actions/{action_id}/cancel"),
    ...
    ("GET", "/api/personnel/resources/{resource_id}/preview"),
    ("GET", "/api/personnel/online-sessions/google/authorize"),
    ("GET", "/api/personnel/online-sessions/google/callback"),
    ...
    ("GET", "/api/participant/resources/{resource_id}/preview"),
