...
const DEMO_ACCOUNTS = [
  ...
  { label: 'Coordinateur', email: 'coordinateur@eduos.ma', color: '#059669' },
  { label: 'Commercial', email: 'commercial@eduos.ma', color: '#C9922A' },
  { label: 'Formateur', email: 'formateur@eduos.ma', color: '#2563EB' },
  { label: 'Enseignant', email: 'enseignant@eduos.ma', color: '#7C3AED' },
    ...
    <div className="auth-page auth-login-page">
      ...
      <div className="auth-card auth-login-card">
        ...
        <p className="auth-switch">
          Votre centre n’a pas encore de compte ? <Link href="/">Envoyer une candidature</Link>
        </p>
