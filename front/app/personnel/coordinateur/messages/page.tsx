...
const INITIAL_TICKETS = [
  { id: 1, nom: 'Ahmed Cherkaoui', sujet: "Absence au cours du 21 juillet", temps: 'Il y a 1h', statut: 'Ouvert', messages: [
    ...
    { from: 'Personnel', text: "Bonjour Ahmed ! Bien sûr, nous allons vous organiser une session de rattrapage. Pouvez-vous être disponible samedi matin ?", time: '10:45', own: true },
  ...
  { id: 2, nom: 'Fatima Zahra El Idrissi', sujet: "Question sur les ressources du cours", temps: 'Il y a 3h', statut: 'En cours', messages: [
    ...
    { from: 'Personnel', text: "Bonjour Fatima ! Je vous transmets le lien maintenant. Les ressources sont disponibles dans l'onglet 'Ressources' de votre espace.", time: '09:00', own: true },
  ]},
  { id: 3, nom: 'Karim Ouali', sujet: "Changement de groupe souhaité", temps: 'Il y a 5h', statut: 'Résolu', messages: [
    ...
    { from: 'Personnel', text: "Changement effectué ! Vous êtes maintenant inscrit dans le groupe Anglais B1 — Soir. La prochaine session est mardi.", time: '09:15', own: true },
  ]},
...
export default function MessagesPage() {
    ...
    setTickets(prev => prev.map(t => {
      if (t.id === active.id) {
        return {
          ...t,
          statut: 'En cours',
          messages: [...t.messages, { from: 'Personnel', text: replyText.trim(), time: timeStr, own: true }]
        }
      }
      return t
    }))
  ...
  const handleCreateTicket = () => {
    const created = {
      ...
      temps: 'À l\'instant',
      statut: 'Ouvert',
      messages: [{ from: 'Personnel', text: newTicket.text, time: 'À l\'instant', own: true }]
    }
