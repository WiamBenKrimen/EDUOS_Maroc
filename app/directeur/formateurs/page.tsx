...
const INITIAL_FORMATEURS = [
  { id: 1, nom: 'Karim Alaoui', specialite: 'Langues — Anglais B1 / B2', groupes: 3, sessions: 24, taux: 120, note: 4.8, email: 'k.alaoui@eduos.ma', tel: '06 61 22 33 44' },
  { id: 2, nom: 'Laila Bennouna', specialite: 'Langues — Français A2 / B2', groupes: 2, sessions: 18, taux: 110, note: 4.9, email: 'l.bennouna@eduos.ma', tel: '06 62 33 44 55' },
  { id: 3, nom: 'Omar El Fassi', specialite: 'Langues — Espagnol & Arabe', groupes: 2, sessions: 12, taux: 100, note: 4.7, email: 'o.elfassi@eduos.ma', tel: '06 63 44 55 66' },
  { id: 4, nom: 'Sanae Tahiri', specialite: 'Management & Gestion de projet', groupes: 1, sessions: 16, taux: 130, note: 4.6, email: 's.tahiri@eduos.ma', tel: '06 64 55 66 77' },
  { id: 5, nom: 'Youssef Chraibi', specialite: 'Marketing digital & Social Media', groupes: 1, sessions: 10, taux: 115, note: 4.5, email: 'y.chraibi@eduos.ma', tel: '06 65 66 77 88' },
  { id: 6, nom: 'Nadia Rami', specialite: 'Anglais intensif & TOEFL', groupes: 2, sessions: 20, taux: 140, note: 5.0, email: 'n.rami@eduos.ma', tel: '06 66 77 88 99' },
]
...
export default function FormateursPage() {
  ...
  const handleAddFormateur = (e: React.FormEvent) => {
    ...
    const newEntry = {
      ...
      note: 5.0,
      email: `${newNom.toLowerCase().replace(/ /g, '.')}@eduos.ma`,
      tel: '06 60 00 00 00'
    }
    setFormateurs([newEntry, ...formateurs])
    setShowAddModal(false)
    triggerToast(`Formateur "${newNom}" ajouté avec succès !`)
    setNewNom('')
    setNewSpec('')
  }
        ...
        <div style={{
          ...
          <div style={{ background: '#fff', borderRadius: 16, width: '100%', maxWidth: 460, overflow: 'hidden', boxShadow: '0 20px 50px rgba(0,0,0,0.25)' }}>
            <div style={{ padding: '18px 24px', background: NAVY, color: '#fff', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <h3 style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 800, fontSize: 16, margin: 0 }}>Nouveau Formateur</h3>
            ...
            <form onSubmit={handleAddFormateur} style={{ padding: 24 }}>
              ...
              <div style={{ marginBottom: 14 }}>
                <label style={{ display: 'block', fontSize: 12, fontWeight: 700, color: NAVY, marginBottom: 4 }}>Spécialité & Langues</label>
                <input
                  type="text"
      ...
      {selectedFormateur && (
        <div style={{
          ...
          <div style={{ background: '#fff', borderRadius: 16, width: '100%', maxWidth: 480, overflow: 'hidden', boxShadow: '0 20px 50px rgba(0,0,0,0.25)' }}>
            <div style={{ padding: '18px 24px', background: NAVY, color: '#fff', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <h3 style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 800, fontSize: 16, margin: 0 }}>Profil Formateur</h3>
