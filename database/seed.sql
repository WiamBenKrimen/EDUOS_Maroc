...
TRUNCATE TABLE
  ...
  inscriptions, cohortes, formations, formateurs, participants, prospects,
...
INSERT INTO users (id, centre_id, role, nom, prenom, email, telephone, password_hash) VALUES
('10000000-0000-0000-0000-000000000001','00000000-0000-0000-0000-000000000001','directeur','Bennani','Ahmed','directeur@eduos.ma','+212 6 10 10 10 10',crypt('demo1234',gen_salt('bf'))),
('10000000-0000-0000-0000-000000000002','00000000-0000-0000-0000-000000000001','operateur','Alaoui','Sara','operateur@eduos.ma','+212 6 20 20 20 20',crypt('demo1234',gen_salt('bf'))),
('10000000-0000-0000-0000-000000000003','00000000-0000-0000-0000-000000000001','participant','Bennani','Yasmine','participant@eduos.ma','+212 6 12 34 56 78',crypt('demo1234',gen_salt('bf'))),
('10000000-0000-0000-0000-000000000004','00000000-0000-0000-0000-000000000001','formateur','Alaoui','Karim','k.alaoui@eduos.ma','+212 6 61 22 33 44',crypt('demo1234',gen_salt('bf'))),
('10000000-0000-0000-0000-000000000005','00000000-0000-0000-0000-000000000001','participant','Cherkaoui','Ahmed','ahmed.cherkaoui@email.ma','+212 6 61 12 34 56',crypt('demo1234',gen_salt('bf'))),
('10000000-0000-0000-0000-000000000006','00000000-0000-0000-0000-000000000001','participant','El Idrissi','Fatima Zahra','fatima.elidrissi@email.ma','+212 6 62 45 67 89',crypt('demo1234',gen_salt('bf')));
...
INSERT INTO formateurs (id,user_id,centre_id,code,specialite,taux_horaire,note) VALUES
('30000000-0000-0000-0000-000000000001','10000000-0000-0000-0000-000000000004','00000000-0000-0000-0000-000000000001','FOR-001','Langues — Anglais B1 / B2',120,4.8);
...
('40000000-0000-0000-0000-000000000001','00000000-0000-0000-0000-000000000001','10000000-0000-0000-0000-000000000002','Yasmine Ait Ouali','y.aitouali@gmail.com','06 61 12 34 56','Anglais B1','Site web','nouveau',now()-interval '2 days'),
('40000000-0000-0000-0000-000000000002','00000000-0000-0000-0000-000000000001','10000000-0000-0000-0000-000000000002','Mehdi Bensouda','m.bensouda@gmail.com','06 62 45 67 89','Espagnol débutant','WhatsApp','en_cours',now()-interval '5 days');
...
INSERT INTO cohortes (id,formation_id,formateur_id,code,nom,date_debut,date_fin,capacite,salle,jours_semaine,heure_debut,heure_fin) VALUES
...
INSERT INTO seances (id,cohorte_id,formateur_id,titre,description,starts_at,ends_at,salle,statut) VALUES
('80000000-0000-0000-0000-000000000001','60000000-0000-0000-0000-000000000001','30000000-0000-0000-0000-000000000001','Present perfect & conversation','Pratique guidée et conversation','2025-01-27 10:00+01','2025-01-27 12:00+01','Salle 1','planifiee'),
('80000000-0000-0000-0000-000000000002','60000000-0000-0000-0000-000000000001','30000000-0000-0000-0000-000000000001','Compréhension orale','Écoute et restitution','2025-01-29 10:00+01','2025-01-29 12:00+01','Salle 1','planifiee'),
('80000000-0000-0000-0000-000000000003','60000000-0000-0000-0000-000000000001','30000000-0000-0000-0000-000000000001','Expression écrite','Production écrite B2','2025-01-24 09:00+01','2025-01-24 11:00+01','Salle 1','terminee');
...
('90000000-0000-0000-0000-000000000001','70000000-0000-0000-0000-000000000001','FAC-2025-0001','2025-01-01','2025-01-01','2025-01-05',450,'paye'),
...
INSERT INTO rapports_suivi (id,inscription_id,formateur_id,periode,score_global,taux_presence,appreciation,publie_at) VALUES
...
INSERT INTO remunerations (formateur_id,periode,heures,taux_horaire,statut) VALUES
