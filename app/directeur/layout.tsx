    ...
    <div style={{ display: 'flex', height: '100vh', background: '#F5F6F8', fontFamily: "'Inter', system-ui, sans-serif" }}>
      ...
      <aside style={{
        ...
        <div style={{ padding: '26px 20px 22px', borderBottom: '1px solid rgba(255,255,255,.07)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            ...
            <div>
              ...
              <div style={{ fontSize: 10.5, color: GOLD, fontWeight: 700, letterSpacing: '0.8px', textTransform: 'uppercase', marginTop: 3 }}>Direction</div>
            </div>
          </div>
        </div>
        ...
        <nav style={{ flex: 1, padding: '14px 10px', overflowY: 'auto' }}>
          <div style={{ fontSize: 9.5, fontWeight: 700, color: 'rgba(255,255,255,.25)', letterSpacing: '1.2px', textTransform: 'uppercase', padding: '0 12px 10px' }}>Menu principal</div>
          {navItems.map((item) => {
        ...
        <div style={{ padding: '14px 16px', borderTop: '1px solid rgba(255,255,255,.07)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 11 }}>
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{ fontSize: 13, fontWeight: 600, color: '#fff', fontFamily: "'Plus Jakarta Sans', sans-serif", whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>Ahmed Bennani</div>
              <div style={{ fontSize: 11, color: 'rgba(255,255,255,.4)', marginTop: 1 }}>Directeur</div>
            </div>
            <LogoutButton />
          </div>
        </div>
      ...
      <div style={{ flex: 1, marginLeft: 248, display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
        ...
        <header style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            <span style={{ fontSize: 11.5, color: 'rgba(27,58,107,.38)', fontWeight: 500 }}>Direction</span>
            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="rgba(27,58,107,.28)" strokeWidth="2"><polyline points="9 18 15 12 9 6" /></svg>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            <button style={{
              position: 'relative', background: '#F5F6F8', border: 'none', cursor: 'pointer',
              ...
              <span style={{
                ...
                background: GOLD, border: '1.5px solid #fff',
              }} />
            </button>
