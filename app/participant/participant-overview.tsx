...
export default function ParticipantOverview({ onCourse, onProgress, onNotice, notices }:{
  ...
  return <div className="overview-pro">
    ...
    <nav className="overview-tabs">
      <button className="active">Vue d’ensemble</button><button onClick={onCourse}>Mon agenda</button><button onClick={onProgress}>Ma progression</button><Link href="/participant/documents">Documents</Link><Link href="/participant/notifications">Activité</Link>
    </nav>
    ...
    <section className="overview-analytics">
      <div className="overview-rings">
        ...
        <Link href="/participant/paiement"><span className="overview-ring green" style={{'--value':'92%' } as React.CSSProperties}><i><strong>450</strong><small>DH à venir</small></i></span></Link>
      </div>
    ...
    <section className="overview-main">
      ...
      <aside className="overview-activity">
        <div className="overview-section-title"><div><span>ACTIVITÉ</span><h2>À ne pas manquer</h2></div><Link href="/participant/notifications">Tout voir</Link></div>
    ...
    <footer className="overview-footer">
      ...
      <div className="overview-footer-links">
        <Link href="/participant/ressources"><span className="quick-icon"><svg width="21" height="21" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20V4H6.5A2.5 2.5 0 0 0 4 6.5z"/><path d="M4 6.5v13"/></svg></span><span><strong>Continuer le cours</strong><small>Reprendre vos ressources B2</small></span><i>→</i></Link>
        <Link href="/participant/paiement"><span className="quick-icon gold"><svg width="21" height="21" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><rect x="2" y="5" width="20" height="14"/><path d="M2 10h20"/></svg></span><span><strong>Gérer mes paiements</strong><small>Échéances, historique et reçus</small></span><i>→</i></Link>
        <Link href="/participant/documents"><span className="quick-icon green"><svg width="21" height="21" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M14 2H6v20h12V6z"/><path d="M14 2v6h6M8 13h8M8 17h6"/></svg></span><span><strong>Mes documents</strong><small>Consulter et télécharger</small></span><i>→</i></Link>
      </div>
    </footer>
  </div>
}
